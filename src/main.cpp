...
$on_mod(Loaded) {
	...
	ADD_TOGGLE("Hide All Player Particles", "noPlayerParticles", "Hide the particle effects from various player actions, including running on the floor, flying the ship, controlling your swing, and jumping as a robot.\n\n<c_>Be mindful that this setting overrides a lot of player particle-related toggles.</c>")
	ADD_TOGGLE("Hide Cube Ground Particles", "noCubeGroundParticles", "Hide the ground particle effects when being a cube.")
	ADD_TOGGLE("Hide Ball Ground Particles", "noBallGroundParticles", "Hide the ground particle effects when being a ball.")
	ADD_TOGGLE("Hide Robot Ground Particles", "noRobotGroundParticles", "Hide the ground particle effects when being a robot.")
	ADD_TOGGLE("Hide Spider Ground Particles", "noSpiderGroundParticles", "Hide the ground particle effects when being a spider.")
	ADD_TOGGLE("Hide Ship Trailing Particles", "noShipTrailingParticles", "Hide the trailing particle effects when being a ship.")
	ADD_TOGGLE("Hide UFO Trailing Particles", "noUFOTrailingParticles", "Hide the trailing particle effects when being a UFO.")
	ADD_TOGGLE("Hide Swing Trailing Particles", "noSwingTrailingParticles", "Hide the trailing particle effects when being a swing.")
	ADD_TOGGLE("Hide Ship Clicking Particles", "noShipClickParticles", "Hide the particle effects from controlling the ship.")
	ADD_TOGGLE("Hide UFO Clicking Particles", "noUFOClickParticles", "Hide the particle effects from controlling the UFO.")
	ADD_TOGGLE("Hide Ship Ground Particles", "noShipGroundParticles", "Hide the ground particle effects when being a ship.")
	ADD_TOGGLE("Hide UFO Ground Particles", "noUFOGroundParticles", "Hide the ground particle effects when being a UFO.")
	ADD_TOGGLE("Hide Wave Ground Particles", "noWaveGroundParticles", "Hide the ground particle effects when being a wave.")
	ADD_TOGGLE("Hide Swing Ground Particles", "noSwingGroundParticles", "Hide the ground particle effects when being a swing.")
	ADD_TOGGLE("Hide Robot Burst Particles", "noRobotBurstParticles", "Hide the particle effects from controlling the robot.")
	ADD_TOGGLE("Hide Player Dashing Particles", "noDashingParticles", "Hide the particle effects from using a dash orb.")
	ADD_TOGGLE("Hide Swing Burst Particles", "noSwingBurstParticles", "Hide the particle effects from controlling the swing.")
	ADD_TOGGLE("Hide Player Landing Particles", "noLandingParticles", "Hide the particle effects from landing onto solid objects.")
